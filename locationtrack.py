...
META_URL = 'https://github.com/Gokulkrish-CEH/Location-Tracker/blob/main/metadata.json'
...
def banner():
	...
	art = r'''
      _____ _   _ _____     _____ ____  ____   ____  _____ 
/  ___| \ | |  __ \   / ____/ __ \|  _ \ / __ \|  __ \
\ `--.|  \| | |  | | | |   | |  | | |_) | |  | | |__) |
 `--. \ . ` | |  | | | |   | |  | |  _ <| |  | |  ___/
/\__/ / |\  | |__| | | |___| |__| | |_) | |__| | |    
\____/|_| \_|_____/  \_____\____/|____/ \____/|_|'''

	print(f'{G}{art}{W}\n')
	print(f'{G}[>] {C}Created By   : {W}Gokulkrish_ethicalhacker')
